...
from utils import get_layer, _p, numpy_floatX
...
def cross_entropy(p_y_given_x, y):
    return T.sum(T.nnet.categorical_crossentropy(p_y_given_x, y))
...
def create_shared(value, name):
    return theano.shared(value=np.array(value, dtype=theano.config.floatX), name=name)
